  ...
  <?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (count($_FILES) > 0) {
            ...
            $ini = file_get_contents($_FILES['profile_picture']['tmp_name']);
            ...
            $update_query = "UPDATE user SET email = '$new_email', name = '$new_name', profile_picture = '$ini' WHERE user_id = '$user_id'";
        } else {
